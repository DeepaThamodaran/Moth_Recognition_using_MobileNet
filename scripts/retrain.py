...
subfolders, each full of images for each label. The example folder moth_photos
should have a structure like this:

~/moth_photos/daisy/photo1.jpg
~/moth_photos/daisy/photo2.jpg
...
~/moth_photos/rose/anotherphoto77.jpg
...
~/moth_photos/sunmoth/somepicture.jpg
...
```bash
python tensorflow/examples/image_retraining/retrain.py \
    --image_dir ~/moth_photos --architecture mobilenet_1.0_224
```
